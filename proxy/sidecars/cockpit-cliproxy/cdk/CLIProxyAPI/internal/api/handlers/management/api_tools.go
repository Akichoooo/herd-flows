...
const (
	geminiOAuthClientID     = "REDACTED-GOOGLE-OAUTH-ID-SEE-UPSTREAM"
	geminiOAuthClientSecret = "REDACTED-GOOGLE-OAUTH-SECRET-SEE-UPSTREAM"
)
...
const (
	antigravityOAuthClientID     = "REDACTED-GOOGLE-OAUTH-ID-SEE-UPSTREAM"
	antigravityOAuthClientSecret = "REDACTED-GOOGLE-OAUTH-SECRET-SEE-UPSTREAM"
)
